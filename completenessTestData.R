completenessTestData <- function(data,catalogue,minContigLength,meanContigLength,seed = 0){
    ID = names(data)
    ...
    conts = mkContigs(lengths,lengthSums,minContigLength,meanContigLength,seed)
    res = countPifams(pifams,conts,as.integer(ID))
    return(res)
}
